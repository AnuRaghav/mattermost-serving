#!/usr/bin/env python3
"""Train a tiny TF-IDF + LogisticRegression pipeline and save baseline artifact."""
...
# Label 0 = non-toxic, 1 = toxic (positive class for predict_proba[:, 1])
TEXTS = [
...
def main() -> None:
    ...
    out_path = repo_root / "models" / "toxicity_pipeline.joblib"
